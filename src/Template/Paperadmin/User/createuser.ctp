                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="user_code" name="user_code" class="form-control" placeholder="Enter  User code">
													<small class="user_code_validate">Validate </small> 
										...
										<?php } ?>
                                           ...
                                           <div class="col-md-6">
											...
											<div class="col-md-12 route_area">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="custom-control custom-radio">
                                                            <input id="radio1" value="adv" name="balance_type" type="radio" class="custom-control-input">
                                                            <span class="custom-control-indicator"></span>
                                                            <span class="custom-control-description">Advance</span>
                                                        </label>
                                                        <label class="custom-control custom-radio">
                                                            <input id="radio2" value="outstanding" name="balance_type" type="radio" checked class="custom-control-input">
                                                            <span class="custom-control-indicator"></span>
...
function Areadata(val) {
	var base_url = window.location.origin+"/paperadmin";
	// alert(val);
	if(val!=-1)
	{
		$.ajax({
